...
import sn_p
from sn_plot import plot_NO2_T_scatter, plot_NO2_CV_emi_ratio
from sn_plot import plot_NO2_T_series
...
# usage:
# python main_plot_NO2_VCD.py startDate endDate emi_month region
...
# plot_NO2_T_series
plot_NO2_T_series(data_dict, sat_var_list[0],
        mod_varname_str, scene_tup, T_name=T_name)
figname = fig_dir + region_name + '_series_NO2_T_' + \
        file_str0 + AK + '_' + startDate + '_' + endDate + \
        '_cv_' + str(sat_cv_thre)  + '.png'
plt.savefig(figname, format='png', dpi=300)

# plot
plot_NO2_T_scatter(data_dict, sat_var_list[0],
        mod_varname_str, scene_tup, T_name=T_name)
figname = fig_dir + region_name + '_NO2_T_' + \
        file_str0 + AK + '_' + startDate + '_' + endDate + \
        '_cv_' + str(sat_cv_thre)  + '.png'
plt.savefig(figname, format='png', dpi=300)
