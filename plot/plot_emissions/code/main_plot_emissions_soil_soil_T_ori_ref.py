...
scene_tup = ['soil_T_ori', 'soil_T_obs', 'ori', 'surf_T_obs']
...
figname = fig_dir + varname + '_' + month + '_soil_T_obs_ref.png'
...
figname = fig_dir + varname + '_diff_' + month + '_soil_T_obs_ref.png'
plt.savefig(figname, format='png', dpi=300)
