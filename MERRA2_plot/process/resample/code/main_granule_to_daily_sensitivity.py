...
scene_list = ['ori', 'soil_T_ori', 'surf_T_obs', 'soil_T_obs',
        'soil_T_obs_fit_18_degree', 'soil_T_obs_fit_18_degree_scale_0.60',
        'soil_T_obs_fit_18_degree_scale_0.70',
        'soil_T_obs_fit_18_degree_scale_0.80',
        'soil_T_obs_fit_OMI_NO2', 'soil_T_obs_scale_0.60',
        'soil_T_obs_scale_0.65', 'soil_T_obs_scale_0.70',
        'soil_T_obs_scale_0.75', 'soil_T_obs_scale_0.80']

tp_list = ['tp_sat']

root_granule_dir = '../data/sensitivity/granule/'

root_daily_dir = '../data/sensitivity/daily/'
...
while currDate_D <= endDate_D:
    ...
    # find all files
    granule_dir = root_granule_dir + currDate[0:4] + '/'
