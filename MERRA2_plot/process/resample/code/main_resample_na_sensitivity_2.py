...
scene_for_common = 'soil_T_obs'

# scene_for_common must be the first one
scene_list = [scene_for_common, 'ori',
        'ori_all_scale_0.50',
...
gc_rel_path = 'runs/merra2_05x0625_tropchem_na_' + yyyymm  + '/OutputDir/'
...
MERRA2_plot/process/resample/data/na_sensitivity_2/granule/'
...
mod_coord_dict['mod_lat_start'] =    9.75
mod_coord_dict['mod_lat_end']   =   70.25
mod_coord_dict['mod_lat_step']  =    0.5
mod_coord_dict['mod_lon_start'] = -140.3125
mod_coord_dict['mod_lon_end']   =  -39.6875
mod_coord_dict['mod_lon_step']  =    0.625
