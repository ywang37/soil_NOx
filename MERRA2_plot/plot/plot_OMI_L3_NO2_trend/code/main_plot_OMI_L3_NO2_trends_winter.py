...
# python main_plot_OMI_L3_NO2_trends.py --time_range=2005-2019_06-08
...
mean_vmin = 0
mean_vmax = 8
mean_units = r'OMI L3 NO$_2$ [10$^{15}$  molec cm$^{-2}$]'

trend_vmax = 0.1
trend_vmin = -trend_vmax
trend_units = r'OMI L3 NO$_2$ trend [10$^{15}$ molec cm$^{-2}$ a$^{-1}$]'

sigma_units = r'Standard deviation of OMI L3 NO$_2$ trend ' + \
...
try:
    ...
    print('python main_plot_OMI_L3_NO2_trends.py -tr <time_range> ')
    sys.exit(2)
for opt, arg in opts:
