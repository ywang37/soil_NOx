...
in_data_dir = '/Dedicated/jwang-data/ywang/soil_NOx/process/\
...
for iyr in range(start_year, end_year+1):
    ...
    for imo in month_list:
        ...
        T_file = in_data_dir + 'OMI_NO2_' + yyyy + '-' + mm + '_' + res + '.nc'
        ...
        T_mon.append(indata[varn] / 1e15) # molec/cm2 => 1e15 molec/cm2
...
# units
units_dict = {}
units_dict['mean'] = '1e15 molec/cm2'
units_dict['trend'] = '1e15 molec/cm2/a'
units_dict['trend_sigma'] = '1e15 molec/cm2/a'

# output
outfile = out_data_dir + 'OMI_L3_NO2_' + sy_c + '-' + ey_c + '_winter' + '.nc'
