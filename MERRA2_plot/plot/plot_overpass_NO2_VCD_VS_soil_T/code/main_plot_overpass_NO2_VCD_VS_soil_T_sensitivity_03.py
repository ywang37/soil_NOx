...
old_labels = ['OMI', 
        r'T$_{soil}$_S$_{new}$_fit_18',
        r'T$_{soil}$_S$_{new}$_fit_18_0.60',
        r'T$_{soil}$_S$_{new}$_fit_18_0.70',
        r'T$_{soil}$_S$_{new}$_fit_18_0.80',
        r'T$_{soil}$_S$_{new}$_fit_OMI_NO$_2$',]
...
scene_tup = ['soil_T_obs_fit_18_degree',
