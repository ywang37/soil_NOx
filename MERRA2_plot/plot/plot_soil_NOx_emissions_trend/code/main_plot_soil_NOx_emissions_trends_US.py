...
mean_vmin = 0
mean_vmax = 20
mean_units = r'Soil NO$_x$ emissions [ng N m$^{-1}$ s$^{-1}$]'

trend_vmax = 1
trend_vmin = -trend_vmax
trend_units = r'Soil NO$_x$ emissions trend [ng N m$^{-1}$ s$^{-1}$ a$^{-1}$]'

sigma_units = r'Standard deviation of soil NO$_x$ emissions trend ' + \
        r'[ng N m$^{-1}$ s$^{-1}$ a$^{-1}$]'
...
for scene in scene_tup:
    ...
    name = scene + '_EmisNO_Soil_' + time_range
