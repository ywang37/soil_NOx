...
MERRA2_plot/process/resample/data/monthly/'
...
for NO2_varn in NO2_varn_list:
    ...
    for iyr in range(start_year, end_year+1):
        ...
        for imo in range(start_month, end_month+1):
            ...
            T_file = soil_T_NO2_root_dir + 'model_satellite_' + \
                    yyyy + '-' + mm + '-01_' + \
            ...
            # read NO2 data
            NO2_file = soil_T_NO2_root_dir + 'model_satellite_' + \
                    yyyy + '-' + mm + '-01_' + \
                    yyyy + '-' + mm + '-' + month_days_dict[mm] + '.nc'
    ...
    # output
    outfile = data_dir + 'corr_overpass_' + varn + '_' + NO2_varn + '_' + \
