...
process/resample/data/daily/'

fig_dir = '../figure/'

varname_list = ['mod_Met_GWETTOP', 'mod_Met_TS', 'mod_Met_TSOIL1']

T_list = ['mod_Met_TS', 'mod_Met_TSOIL1']
...
ylabel_dict = {}
ylabel_dict['mod_Met_GWETTOP'] = 'Soil water-filled pore space [%]'
ylabel_dict['mod_Met_TS'] = u'2-m temperature [\u00B0C]'
ylabel_dict['mod_Met_TSOIL1'] = u'Soil temperature [\u00B0C]'
...
while currDate_D <= endDate_D:
    ...
    in_filename = root_data_dir + yyyy + '/model_satellite_' + currDate + '.nc'
...
for varn in varname_list:
    ...
    figname = fig_dir + 'overpass_' + varn + '_' + startDate + '_' + \
            endDate + '.png'
